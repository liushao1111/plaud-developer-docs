...
```bash cURL
curl -X POST "https://platform.plaud.ai/api/workflow/submit" \
...
```
```bash cURL
curl -X GET "https://platform.plaud.ai/api/workflow/{workflow_id}/status" \
  -H "Authorization: Bearer <your_api_token_here>"
```
</CodeGroup>
...
```
```bash cURL
curl -X GET "https://platform.plaud.ai/api/workflow/{workflow_id}/result" \
  -H "Authorization: Bearer <your_api_token_here>"
```
</CodeGroup>
...
class PlaudWorkflowClient:
    ...
    def __init__(self, api_token: str, client_id: str, base_url: str = "https://platform.plaud.ai/api"):
