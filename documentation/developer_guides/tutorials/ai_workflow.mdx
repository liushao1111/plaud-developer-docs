...
<CardGroup cols={2}>
  ...
  <Card title="3. Upload Audio Recording" icon="upload" href="/documentation/developer_guides/tutorials/files/upload">
    Upload your audio files to our platform for processing.
  </Card>
  <Card title="4. Create Custom Template" icon="pen-to-square" href="#">
...
<CardGroup cols={2}>
  <Card title="Custom Templates" icon="pen-ruler" href="#">
    Learn to create, manage, and version templates for precise data extraction.
  </Card>
  <Card title="Webhook Events" icon="webhook" href="#">
