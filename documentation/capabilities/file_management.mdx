...
<Card title="Device Bind Quickstart" href="/documentation/developer_guides/tutorials/device_operations" icon="/assets/icons/content/device_bind_quickstart.svg">
...
<Columns cols={1}>
    <Card title="File Upload Quickstart" href="/documentation/developer_guides/tutorials/files" icon="/assets/icons/content/file_upload_quickstart.svg">
...
<Columns cols={2}>
    <Card title="AI Summary" href="/documentation/capabilities/ai_summary" icon="/assets/icons/content/ai_summary-1.svg">
        Generate intelligent summaries from transcripts.
    </Card>
    <Card title="AI Workflow" href="/documentation/capabilities/ai_workflow" icon="/assets/icons/content/ai_workflow-1.svg">
