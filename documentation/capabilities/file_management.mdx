...
<Card title="Device Bind Quickstart" href="/documentation/developer_guides/tutorials/device_operations" icon="book-sparkles">
...
<Columns cols={1}>
    <Card title="File Upload Quickstart" href="/documentation/developer_guides/tutorials/files" icon="files">
