...
<Columns cols={2}>
  <Card
    ...
    icon="bluetooth"
  >
    Control your device and transfer data in real-time via Bluetooth.
  </Card>
  <Card
    title="Recording Management"
    icon="cassette-tape"
  >
    Start, stop, and manage recordings directly from a connected app.
  </Card>
</Columns>
...
<Columns cols={2}>
  <Card
    ...
    icon="wifi"
  >
    Automatically sync recordings to the cloud over Wi-Fi.
  </Card>
  <Card
    title="Version Management"
    icon="cloud-arrow-up"
  >
    Receive the latest features with automatic OTA firmware updates.
  </Card>
</Columns>
